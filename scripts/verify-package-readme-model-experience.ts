...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/desktop-app': { kind: 'none', reason: 'The patch layer only flips host-owned web runtime config; prompts and tools belong to the composed base and web-app bundles.' },
